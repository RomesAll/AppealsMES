...
{
    public partial class EmployeeFormAdd : Form
    {
        ...
        private void AddClients_Click(object sender, EventArgs e)
        {
            if (isValidEmail(EmailTx.Texts) == true)
            {
                ...
                {
                    if (ClassEmployee.AddEmployee(comboBox1.SelectedValue.ToString(), SurnameTx.Texts, NameTx.Texts, PatronymicTx.Texts, dateTimePicker1.Text, EmailTx.Texts, TelephoneTx.Text, LoginTx.Texts, PasswordTx.Texts) == true)
                    {
