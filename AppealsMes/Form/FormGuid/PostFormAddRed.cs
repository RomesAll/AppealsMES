...
{
    public partial class PostFormAddRed : Form
    {
        public PostFormAddRed()
        {
            InitializeComponent();
            SelectModeCm.SelectedIndex = 0;
            ClassGuide.PostSelect();
            SelectStatusDg.DataSource = ClassGuide.DtPost;
        }
            ...
            switch (SelectModeCm.SelectedIndex)
            {
                case 0:
                    if (NameTb.Texts != "")
                    {
                        ...
                        {
                            if (ClassGuide.PostAdd(NameTb.Texts) == true)
                            {
                ...
                case 1:
                    if (NameTb.Texts != "")
                    {
                        if (Checking_duplication(NameTb.Texts) == false)
                        {
                            if (ClassGuide.PostRed(NomerTb.Texts, NameTb.Texts) == true)
                            {
                ...
                case 2:
                    ...
                    {
                        if (ClassGuide.PostDel(NomerTb.Texts) == true)
                        {
