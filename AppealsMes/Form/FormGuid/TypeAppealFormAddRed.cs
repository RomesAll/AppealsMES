...
{
    public partial class TypeAppealFormAddRed : Form
    {
        public TypeAppealFormAddRed()
        {
            InitializeComponent();
            SelectModeCm.SelectedIndex = 0;
            ClassGuide.TypeAppealSelect();
            SelectStatusDg.DataSource = ClassGuide.DtTypeAppeal;
        }
            ...
            switch (SelectModeCm.SelectedIndex)
            {
                case 0:
                    if (NameTb.Texts != "")
                    {
                        ...
                        {
                            if (ClassGuide.TypeAppealAdd(NameTb.Texts) == true)
                            {
                ...
                case 1:
                    if (NameTb.Texts != "")
                    {
                        if (Checking_duplication(NameTb.Texts) == false)
                        {
                            if (ClassGuide.TypeAppealRed(NomerTb.Texts, NameTb.Texts) == true)
                            {
                ...
                case 2:
                    ...
                    {
                        if (ClassGuide.TypeAppealDel(NomerTb.Texts) == true)
                        {
