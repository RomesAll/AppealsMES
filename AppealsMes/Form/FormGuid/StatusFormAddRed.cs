...
{
    public partial class StatusFormAddRed : Form
    {
        public StatusFormAddRed()
        {
            InitializeComponent();
            SelectModeCm.SelectedIndex = 0;
            ClassGuide.StatusesSelect();
            SelectStatusDg.DataSource = ClassGuide.DtStatuses;
        }
            ...
            switch (SelectModeCm.SelectedIndex)
            {
                case 0:
                    if (NameTb.Texts != "")
                    {
                        ...
                        {
                            if (ClassGuide.StatusesAdd(NameTb.Texts) == true)
                            {
                ...
                case 1:
                    if (NameTb.Texts != "")
                    {
                        if (Checking_duplication(NameTb.Texts) == false)
                        {
                            if (ClassGuide.StatusesRed(NomerTb.Texts, NameTb.Texts) == true)
                            {
                ...
                case 2:
                    ...
                    {
                        if (ClassGuide.StatusesDel(NomerTb.Texts) == true)
                        {
