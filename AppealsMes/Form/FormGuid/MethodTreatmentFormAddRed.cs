...
{
    public partial class MethodTreatmentFormAddRed : Form
    {
        public MethodTreatmentFormAddRed()
        {
            InitializeComponent();
            SelectModeCm.SelectedIndex = 0;
            ClassGuide.MethodTreatmentSelect();
            SelectStatusDg.DataSource = ClassGuide.DtMethodTreatment;
        }
            ...
            switch (SelectModeCm.SelectedIndex)
            {
                case 0:
                    if (NameTb.Texts != "")
                    {
                        ...
                        {
                            if (ClassGuide.MethodTreatmentAdd(NameTb.Texts) == true)
                            {
                ...
                case 1:
                    if (NameTb.Texts != "")
                    {
                        if (Checking_duplication(NameTb.Texts) == false)
                        {
                            if (ClassGuide.MethodTreatmentRed(NomerTb.Texts, NameTb.Texts) == true)
                            {
                ...
                case 2:
                    ...
                    {
                        if (ClassGuide.MethodTreatmentDel(NomerTb.Texts) == true)
                        {
