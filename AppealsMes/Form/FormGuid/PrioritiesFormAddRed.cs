...
{
    public partial class PrioritiesFormAddRed : Form
    {
        public PrioritiesFormAddRed()
        {
            InitializeComponent();
            SelectModeCm.SelectedIndex = 0;
            Class.ClassGuide.PrioritiesSelect();
            SelectStatusDg.DataSource = Class.ClassGuide.DtPriorities;
        }
            ...
            switch (SelectModeCm.SelectedIndex)
            {
                case 0:
                    if (NameTb.Texts != "")
                    {
                        ...
                        {
                            if (ClassGuide.PrioritiesAdd(NameTb.Texts) == true)
                            {
                ...
                case 1:
                    if (NameTb.Texts != "")
                    {
                        if (Checking_duplication(NameTb.Texts) == false)
                        {
                            if (ClassGuide.PrioritiesRed(NomerTb.Texts, NameTb.Texts) == true)
                            {
                ...
                case 2:
                    ...
                    {
                        if (ClassGuide.PrioritiesDel(NomerTb.Texts) == true)
                        {
